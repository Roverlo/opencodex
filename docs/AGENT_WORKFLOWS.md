...
Read only the section relevant to the task. These development workflows do not authorize merging, publishing, rebasing another task, or spending user identity. Validation scope is defined in [VALIDATION.md](VALIDATION.md); maintainer requirements remain authoritative.
